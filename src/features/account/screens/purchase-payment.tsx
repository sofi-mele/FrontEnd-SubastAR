...
export function PurchasePaymentScreen() {
  ...
  return (
    <Screen>
      ...
      <SummaryRow label="Monto a regularizar" value={formatCurrency(purchase.amount + purchase.fee + purchase.penalty + (purchase.shippingCost ?? 0), purchase.currency)} bold />
